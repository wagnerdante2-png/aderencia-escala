...
check();
const badge=document.querySelector('.privacy');if(badge)badge.textContent='Processamento local no navegador • v1.0 RC28';
...
/* RC28: PDFs deste modelo são alinhados pela sequência de dias ao período operacional reconhecido no espelho. O cabeçalho visual do PDF não redefine a competência. */
