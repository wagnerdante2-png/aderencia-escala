...
check();
const badge=document.querySelector('.privacy');if(badge)badge.textContent='Processamento local no navegador • v1.0 RC13';
/* Adaptadores registram suas regras antes do engine-v3.js. */
document.write('<script src="point-semantics.js"><\/script>');
document.write('<script src="pdf-schedule-parser.js"><\/script>');
loadBatch();
})();