...
check();
const badge=document.querySelector('.privacy');if(badge)badge.textContent='Processamento local no navegador • v1.0 RC23';
...
/* pdf-period-corrector.js foi removido do pipeline: conflitava com a competência operacional 11→10 do RC22. */
