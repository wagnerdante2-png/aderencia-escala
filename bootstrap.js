...
check();
const badge=document.querySelector('.privacy');if(badge)badge.textContent='Processamento local no navegador • v1.0 RC9';
/* Ambos os adaptadores precisam registrar suas regras antes do engine-v3.js. */
