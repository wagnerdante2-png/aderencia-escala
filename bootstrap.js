...
check();
const badge=document.querySelector('.privacy');if(badge)badge.textContent='Processamento local no navegador • v1.0 RC19';
/* Adaptadores registram suas regras antes do engine-v3.js. */
document.write('<script src="point-semantics.js"><\/script>');
document.write('<script src="pdf-schedule-parser-rc14.js"><\/script>');
document.write('<script src="pdf-period-corrector.js"><\/script>');
document.write('<script src="monitor-export.js"><\/script>');
document.write('<script src="divergence-dashboard.js"><\/script>');
document.write('<script src="divergence-capture-rc19.js"><\/script>');
