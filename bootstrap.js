...
check();
const badge=document.querySelector('.privacy');if(badge)badge.textContent='Processamento local no navegador • v1.0 RC18';
...
document.write('<script src="divergence-capture-fix.js"><\/script>');
loadBatch();
})();