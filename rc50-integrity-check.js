...
function run(){
 ...
 add('version',/^v1\.0 RC5[1-6]$/.test(window.ADERENCIA_VERSION||''),window.ADERENCIA_VERSION||'ausente');
 ...
 add('pdf-store-header-guard',/^RC56(?:\.|$)/.test(window.ADERENCIA_PDF_STORE_GUARD_RC56?.version||''),window.ADERENCIA_PDF_STORE_GUARD_RC56?.version||'ausente');
 add('pdf-parser',/^(?:RC28\+RC51|RC54|RC55)$/.test(window.ADERENCIA_PDF_PARSER_VERSION||''),window.ADERENCIA_PDF_PARSER_VERSION||'ausente');
